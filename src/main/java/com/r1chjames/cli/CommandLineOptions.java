...
public enum CommandLineOptions {
    ...
    SHOULD_PROCESS_FROM_BEGINNING("fb", "shouldProcessFromBeginning", true,true, "Whether to process messages from the beginning of the topic"),
    ...
    DEFAULT_KEY_DESERIALIZER("kd", "default_key_deserializer", false, "org.apache.kafka.common.serialization.StringDeserializer", "Default key deserializer class"),
    DEFAULT_VALUE_DESERIALIZER("vd", "default_value_serializer", false, "com.r1chjames.kafka.ErrorTolerantKafkaAvroDeserializer", "Default value deserializer class"),
